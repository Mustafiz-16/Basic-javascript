//Error Handling is not related to class & object this is another topic
...
try{
    ...
    //try block e kono error ashle amra catch block e ashi cacth block er kaj hocche to handle our error
    //handling error
    console.log(error);

}
//try-catch use korate amaar baki code run hoise upore error thakar pore o
console.log("a+b =",a+b);
console.log("a+b =",a+b);
console.log("a+b =",a+b);
